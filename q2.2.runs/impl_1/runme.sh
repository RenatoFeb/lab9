...
HD_PWD='C:/Users/renat/OneDrive/Desktop/fpga labs/raw/9/q2.2/q2.2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log intConv.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source intConv.tcl -notrace
